...
***IMPORTANT: 
Atmosphère >= 1.9.4 is required to run the latest release of Mission Control on firmware 20.4.0+. Using an older Atmosphère version will cause Mission Control to crash or freeze the system on boot.***
