...
***IMPORTANT: 
Atmosphère >= 1.10.2 is required to run the latest release of Mission Control on firmware 21.2.0+. Using an older Atmosphère version will cause Mission Control to crash or freeze the system on boot.***
