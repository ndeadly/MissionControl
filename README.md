...
***IMPORTANT: 
Atmosphère >= 1.11.0 is required to run the latest release of Mission Control on firmware 22.0.0+. Using an older Atmosphère version will cause Mission Control to crash or freeze the system on boot.***
