...
Result btdrvWriteHidDataFwd(Service* srv, BtdrvAddress address, const BtdrvHidReport *report);
Result btdrvWriteHidData2Fwd(Service* srv, BtdrvAddress address, const void *data, size_t size);
